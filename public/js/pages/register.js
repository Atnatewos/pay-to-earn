...
class RegisterPage {
    ...
    render() {
        ...
        const refCode = router.currentQuery?.ref || '';
                ...
                <div class="auth-card card-glass animate-scaleIn">
                    ...
                    <form id="registerForm" class="auth-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-input" id="phone" placeholder="09XXXXXXXX" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="referralCode" value="${refCode}" readonly>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block btn-lg">Create Account</button>
                    </form>
                    <div class="auth-footer">
                        <p>Have an account? <a onclick="router.navigate('/login')" class="text-primary">Sign In</a></p>
                    </div>
                </div>
            </div>
        `;
        ...
        document.getElementById('registerForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                Dialog.alert(error.message, 'Registration Failed', 'error');
            }
        });
    }
